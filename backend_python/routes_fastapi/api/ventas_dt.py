...
async def ventas_dt(
    ...
    desde = _parse_ymd(desde)
    hasta = _parse_ymd(hasta)
    nombre = nombre.strip()
    ...
    try:
        ...
        return JSONResponse({'draw': draw, 'recordsTotal': 0, 'recordsFiltered': 0, 'data': [], 'error': str(e)}, status_code=500)
